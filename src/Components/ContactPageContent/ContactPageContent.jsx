        ...
        <>
            ...
            <div className="contactpage-info">
                ...
                <div className="contact-address-info">
                    <div className="contact-icons"> <GrLocation /></div>
                ...
                <div className="contact-address-info">
                    <div className="contact-icons"> <BiPhoneCall />
                        <AiOutlineMail />
                    </div>
                    ...
                    <div className="contact-content">
                        ...
                        <div className="contact-address-info">
                    <div className="contact-icons"> <IoMdStopwatch /></div>
                    <div className="contact-content">
                        <h5 className="contact-content-titles">Time Of Operation</h5>
                        <p> Monday – Friday : 09:00 – 20:00
...
<section className="contact-form-section">
      ...
      <input type="text" name="" id="" placeholder="First Name" class="form_design" required />
      <input type="text" name="" id="" placeholder="Last Name" class="form_design" required /> <br />
      <input type="email" name="" id="" placeholder="Email" class="form_design" required /> 
      <input type="tel" name="" id="" placeholder="Phone Number" class="form_design" required  /> <br />
      <textarea name="message" id="message" class="form_design" required ></textarea>
      <br />
